...
| `instructions`   | text   | Описание: «работающие мышцы», «техника», «Совет: …» — три абзаца через `<br>`                            |
...
| `1749500009_exercise_descriptions.js`  | Первые описания `instructions` (скудные, частично с англ-вкраплениями)   |
...
| `1781300000_exercise_descriptions_v2.js` | Переписаны все 299 `instructions` в формат «мышцы / техника / совет» (рерайт tvoytrener + clean-room) |
